...
import strawberryFritter from "../assets/applefritter.jpg";
...
const StrawberryFritter = () => {
  ...
  useEffect(() => {
    if (claimPrice) {
      ...
      const url = `solana:${recipientWallet}?amount=${totalClaimAmount}&spl-token=${CLAIM_TOKEN_ADDRESS}&label=Strawberry%20Fritter&message=Purchase%20of%20${quantity}%20Strawberry%20Fritter%20Rosin`;
      setSolanaPayURL(url);
    }
  }, [claimPrice, quantity]);
  ...
  const handleSendConfirmation = () => {
    ...
    const templateParams = {
      ...
      product: "Strawberry Fritter Rosin",
      quantity: quantity,
      totalUSD: totalUSD,
  ...
  return (
    <div className="product-list-container">
      ...
      <div className="product-details card" style={{ textAlign: "center" }}>
        ...
        <h2 className="product-name">Strawberry Fritter Rosin</h2>
...
export default StrawberryFritter;
