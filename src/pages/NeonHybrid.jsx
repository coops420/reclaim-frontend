...
import productImage from "../assets/hybridneon.png";       // Electric Neon Hybrid Proxy Peak Spillproof
...
// ** PRICING CONFIG (Electric Neon Hybrid) **
const PRODUCT_PRICE_USD = 450; // Final sale price in USD
const RETAIL_PRICE_USD  = 650; // Original crossed-out price for display
...
const NeonHybrid = () => {
  ...
  // EXACT BUY LOGIC with forced shipping + email after success
  const handleBuyNow = useCallback(async () => {
    // 1) Ensure shipping details filled
    ...
    try {
      ...
      // 3) Immediately send emails w/ shipping info
  ...
  return (
    <div className="product-list-container">
      ...
      <div className="product-details card" style={{ textAlign: "center" }}>
        <img
          src={productImage}
          alt="Electric Neon Hybrid Proxy Peak Spillproof"
          className="product-image"
        />
        <h2>Electric Neon Hybrid Proxy Peak Spillproof</h2>
