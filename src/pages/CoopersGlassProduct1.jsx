...
import productImage from "../assets/sonicspillproof.jpg";
...
// ** PRICING CONFIG (Sonic Crushed Opal Spillproof) **
const PRODUCT_PRICE_USD = 325; // Final sale price
const RETAIL_PRICE_USD = 475;  // Original retail for display
...
const CoopersGlassProduct1 = () => {
  ...
  const handleBuyNow = useCallback(async () => {
    // 1) Ensure shipping details are filled
    ...
    try {
      ...
      const templateParams = {
        ...
        email,
        shippingAddress,
        product:      "Sonic Crushed Opal Spillproof", // <-- Updated product name
        totalUSD:     PRODUCT_PRICE_USD,               // 325
  ...
  return (
    <div className="product-list-container">
      ...
      <div className="product-details card" style={{ textAlign: "center" }}>
        <img
          src={productImage}
          alt="Sonic Crushed Opal Spillproof"     // <-- Updated alt text
          className="product-image"
        />
        <h2>Sonic Crushed Opal Spillproof</h2>    {/* <-- Updated Title */}
        <p><del>Retail: ${RETAIL_PRICE_USD}</del></p>  {/* Now 475 */}
        <p>
          {loading
            ? "Loading $CLAIM price..."
            : claimPrice
