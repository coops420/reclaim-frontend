...
import vendorImage from "../assets/coopersglass.jpg"; // Keep Coopers Glass vendor image
import productImage from "../assets/mintcropalpuffer.jpg"; // Updated product image
...
// ** PRICING CONFIG (Now Mint Crushed Opal Puffer) **
const PRODUCT_PRICE_USD = 275; // Final Claim price in USD
const RETAIL_PRICE_USD = 375;  // Original retail for display
...
const MintPufferPurchase = () => {
  ...
  const handleBuyNow = useCallback(async () => {
    ...
    try {
      ...
      console.log(
        `Requesting Phantom Wallet confirmation to send ${CLAIM_AMOUNT} $CLAIM...`
      );
      ...
      alert(
        `Payment Successful! Sent ${CLAIM_AMOUNT} $CLAIM.\nTransaction ID: ${signature}`
      );
  ...
  return (
    <div className="product-list-container">
      ...
      <div className="product-details card" style={{ textAlign: "center" }}>
        ...
        <img
          src={productImage}
          alt="Mint Crushed Opal Puffer"
          className="product-image"
        />
        <h2>Mint Crushed Opal Puffer</h2>
...
export default MintPufferPurchase;
