...
import productImage from "../assets/soniccropalpuffer.jpg"; // Updated product image
  ...
  return (
    <div className="product-list-container">
      ...
      <div className="product-details card" style={{ textAlign: "center" }}>
        ...
        <img
          src={productImage}
          alt="Sonic Crushed Opal Puffer"
          className="product-image"
        />
        <h2>Sonic Crushed Opal Puffer</h2>
...
export default SonicPufferPurchase;
