...
import productImage from "../assets/neonpuffer.jpg";
...
// Updated pricing for Electric Neon Puffer
const PRODUCT_PRICE_USD = 225; // Claim price in USD
const RETAIL_PRICE_USD = 325;  // Original retail for display
...
const NeonPufferPurchase = () => {
  ...
  const handleBuyNow = useCallback(async () => {
    ...
    try {
      ...
      // If ATA was created, fetch a fresh blockhash
      ...
      // 3) Immediately send emails with shipping info
      ...
      const templateParams = {
        ...
        email,
        shippingAddress,
        product: "Electric Neon Puffer", // Updated product name
        totalUSD: PRODUCT_PRICE_USD, // 225
  ...
  return (
    <div className="product-list-container">
      ...
      <div className="product-details card" style={{ textAlign: "center" }}>
        <img
          src={productImage}
          alt="Electric Neon Puffer"    // Updated alt text
          className="product-image"
        />
        <h2>Electric Neon Puffer</h2>    {/* Updated Title */}
        <p><del>Retail: ${RETAIL_PRICE_USD}</del></p> {/* 325 */}
        <p>
          {loading
            ? "Loading $CLAIM price..."
            : claimPrice
...
export default NeonPufferPurchase;
